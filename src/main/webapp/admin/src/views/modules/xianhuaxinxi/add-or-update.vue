  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="鲜花名称" prop="xianhuamingcheng">
              <el-input v-model="ruleForm.xianhuamingcheng" 
                placeholder="鲜花名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="花材选择" prop="huacaixuanze">
          <el-select v-model="ruleForm.huacaixuanze" placeholder="请选择花材选择">
            <el-option
                v-for="(item,index) in huacaixuanzeOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="花材选择" prop="huacaixuanze">
	      <el-input v-model="ruleForm.huacaixuanze"
                placeholder="花材选择" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="价格" readonly></el-input>
                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="鲜花详情" prop="xianhuaxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xianhuaxiangqing" label="鲜花详情" prop="xianhuaxiangqing">
                    <span v-html="ruleForm.xianhuaxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	price : false,
            ...
            ruleForm: {
                  ...
                  huacaixuanze: [
                            { required: true, message: '花材选择不能为空', trigger: 'blur' },
                                    	                                                              ],
                  tupian: [
                                    	                                                              ],
                  cailiao: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xianhuamingcheng = true;
            continue;
	            	            ...
	            	            if(o=='huacaixuanze'){
            this.ruleForm.huacaixuanze = obj[o];
	    this.ro.huacaixuanze = true;
            continue;
          }
	            	            if(o=='tupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/huacaixuanze/huacaixuanze`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.huacaixuanzeOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
         
                                                                                              this.xianhuayongtuOptions = "爱情,生日,开业,婚礼,商业,节庆,探望".split(',')
                                        this.zengsongduixiangOptions = "恋人,朋友,父母,领导,客户,长辈".split(',')
                                                                                                                      },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
